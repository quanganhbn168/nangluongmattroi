                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <div class="text-end mb-2">
                        ...
                        <div>
                            ...
                            {{ optional($order->installation_date ? \Carbon\Carbon::parse($order->installation_date) : $order->created_at)->format('d/m/Y') }}
                        </div>
                        <div><strong>Thợ lắp đặt:</strong> {{ $order->technician->name ?? 'Không có' }}</div>
                    </div>
                </div>
                <hr class="my-2">
                <div class="row">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if($item->warranty_expires_at)
                                    {{ \Carbon\Carbon::parse($item->warranty_expires_at)->format('d/m/Y') }}
                                @else
                                    <span class="text-muted">—</span>
                                @endif
                            </td>
