        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select class="form-control" id="technician_id" name="technician_id">
                    ...
                    @foreach($users as $user)
                        <option value="{{ $user->id }}" @if(old('technician_id', $order->technician_id ?? '') == $user->id) selected @endif>
                            {{ $user->name }}
                        </option>
                    @endforeach
                </select>
        ...
        <tbody id="order-items-table">
            @if(isset($order) && $order->orderItems)
                ...
                <tr data-product-id="{{ $item->product_id }}">
                    ...
                    <td>
                        <select class="form-control item-warranty" name="items[{{ $index }}][warranty_months]">
                            <option value="0" @if($item->warranty_months == 0) selected @endif>Không có</option>
                            <option value="6" @if($item->warranty_months == 6) selected @endif>6 tháng</option>
                            <option value="12" @if($item->warranty_months == 12) selected @endif>1 năm</option>
                            <option value="24" @if($item->warranty_months == 24) selected @endif>2 năm</option>
                            <option value="36" @if($item->warranty_months == 36) selected @endif>3 năm</option>
                            <option value="60" @if($item->warranty_months == 60) selected @endif>5 năm</option>
                        </select>
                    </td>
